...
import telerikProject.commands.change.ChangeBugSeverityCommand;
...
public class ChangeBugSeverityTests {
    ...
    @Test
    public void ChangeBugSeverityTests_ShouldChangeSeverity_WhenPassedCorrectParameters() {
        ...
        changeBugSeverityCommand.execute(Arrays.asList("11","Minor"));
        Assert.assertEquals("Minor",bug.getSeverityType().toString());
    }
}
